...
class Userbot(Client):
    def __init__(self):
        self.one = Client(
            name="RocksMusicAss1",  # Changed from SYSTUMXASS1
        ...
        self.two = Client(
            name="RocksMusicAss2",  # Changed from SYSTUMXASS2
            api_id=config.API_ID,
            api_hash=config.API_HASH,
        ...
        self.three = Client(
            name="RocksMusicAss3",  # Changed from SYSTUMXASS3
            api_id=config.API_ID,
            api_hash=config.API_HASH,
        ...
        self.four = Client(
            name="RocksMusicAss4",  # Changed from SYSTUMXASS4
            api_id=config.API_ID,
            api_hash=config.API_HASH,
        ...
        self.five = Client(
            name="RocksMusicAss5",  # Changed from SYSTUMXASS5
            api_id=config.API_ID,
            api_hash=config.API_HASH,
